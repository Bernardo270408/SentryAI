...
import { FiAlertTriangle, FiClock, FiLock } from "react-icons/fi";
import "../styles/global.css"; // Usa estilos globais
...
export default function BannedPage() {
  ...
  if (!banInfo) {
    // Se não tiver info, volta pra home (provavelmente refresh manual)
    return (
