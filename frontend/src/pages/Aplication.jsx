...
// Variantes UNIFICADAS para os Cards (Entrada + Hover + Tap)
const cardVariants = {
      ...
      <div className="alert-carousel-track" ref={carouselRef}>
        {alerts.map((alert, index) => (
          ...
          >
            ...
            <button className="btn tiny primary" style={{ alignSelf: 'center', padding: '6px 20px' }}> 
              {alert.ctaText}
            </button>
          </motion.div>
        ))}
...
export default function Aplication() {
  ...
  return (
    <div className="landing-root">
      ...
      <motion.main 
        className="application-main container"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.5 }}
      >
          ...
          >
            ...
            >
              <div className="chat-content">
                ...
                <br />
                <p className="muted"><b>Alimentado por GPT-5 e Gemini 3 Pro</b>. Tire dúvidas complexas com nossa IA especializada em direito.</p>
                <br />
                <motion.button 
            ...
            >
              ...
              <p className="muted">Identifique cláusulas abusivas ou incomuns em contratos.</p>
              <button className="btn primary">Analisar Agora</button>
            </motion.article>
